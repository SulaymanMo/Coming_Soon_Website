...
window.onload = () => {
    ...
    d.innerHTML = parseInt(dData.slice(0, 2), 10);
    h.innerHTML = parseInt(hData.slice(0, 2), 10);
    m.innerHTML = parseInt(mData.slice(0, 2), 10);
    s.innerHTML = parseInt(sData.slice(0, 2), 10);
